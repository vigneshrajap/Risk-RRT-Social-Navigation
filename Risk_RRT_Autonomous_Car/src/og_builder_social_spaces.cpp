...
double arg_vel_o;
int ped_num;
custom_pose temp_pose, ped_pose, obstacle, temp_pose_1,ped_pose_1;
...
arg_vel_o=0;
 ...
 // std::cout<<"actual"<<msg.x<<"global"<<TFGlobal(0,3)<<"local"<<TFLocal(0,3)<<std::endl;
  ...
  marker1.pose.position.x = 0.055;
  marker1.pose.position.y = 58;
  marker1.pose.position.z = 0;
  //marker.pose.orientation = msg->pose.pose.orientation;
  marker1.pose.orientation = tf::createQuaternionMsgFromYaw(1.57);
  ...
  marker2.pose.position.y = 56;
  marker2.pose.position.z = 0;
  //marker.pose.orientation = msg->pose.pose.orientation;
  marker2.pose.orientation = tf::createQuaternionMsgFromYaw(60.57);
  ...
  p_marker.pose.position.x = 0.05;
  p_marker.pose.position.y = 42;
  p_marker.pose.position.z = 0;
  //marker.pose.orientation = msg->pose.pose.orientation;
  p_marker.pose.orientation = tf::createQuaternionMsgFromYaw(1.57);
  p_marker.scale.x = 1.5;
  p_marker.scale.y = 1.5;
  ...
  o_marker.pose.position.x = 0.525;
  o_marker.pose.position.y = 57;
  o_marker.pose.position.z = 0;
  //marker.pose.orientation = msg->pose.pose.orientation;
  o_marker.pose.orientation = tf::createQuaternionMsgFromYaw(1.57);
  o_marker.scale.x = 3;
  o_marker.scale.y = 3;
...
{
  ros::init(argc, argv, "og_builder_p_o");
